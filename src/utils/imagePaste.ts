...
function getClipboardCommands() {
  ...
  > = {
    darwin: {
      ...
      saveImage: `osascript -e 'set png_data to (the clipboard as «class PNGf»)' -e 'set screenshot_path to system attribute "SCREENSHOT_PATH"' -e 'set fp to open for access POSIX file screenshot_path with write permission' -e 'write png_data to fp' -e 'close access fp'`,
