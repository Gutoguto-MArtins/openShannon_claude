...
function getClipboardCommands() {
  ...
  > = {
    darwin: {
      ...
      saveImage: `osascript -e 'set screenshotPath to system attribute "SCREENSHOT_PATH"' -e 'set png_data to (the clipboard as «class PNGf»)' -e 'set fp to open for access POSIX file screenshotPath with write permission' -e 'write png_data to fp' -e 'close access fp'`,
